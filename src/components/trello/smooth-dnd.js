...
!function (e, t) {
  ...
  "use strict";
  var l, t, r = "smooth-dnd-container-instance", f = "smooth-dnd-draggable-wrapper", o = "animated",
    p = "__smooth_dnd_draggable_translation_value", u = "__smooth_dnd_draggable_visibility_value",
    v = "smooth-dnd-ghost", g = "smooth-dnd-container", d = "smooth-dnd-extra-size-for-insertion",
    h = "smooth-dnd-stretcher-element", y = "smooth-dnd-stretcher-instance", s = "smooth-dnd-disable-touch-action",
    c = "smooth-dnd-no-user-select", i = "smooth-dnd-prevent-auto-scroll-class",
    b = "smooth-dnd-drop-preview-default-class", w = "smooth-dnd-drop-preview-inner-class",
    x = "smooth-dnd-drop-preview-constant-class", E = "smooth-dnd-drop-preview-flex-container-class",
    n = Object.freeze({
      containerInstance: r,
  ...
  function Y(e) {
    ...
    return function (e, t) {
      ...
      if (null !== o && (a = _(s, o), c.splice(o, 1)), null !== r) {
        ...
        l.className = "".concat(f), l.appendChild(__targetElement.firstElementChild), F(s, l, r), r >= c.length ? c.push(l) : c.splice(r, 0, l);
      }
      t && t(e);
    };
  }
  ...
  function q(n, s, e) {
    ...
    }("horizontal" === s ? G : W), c = {translation: 0};
    ...
    return window.addEventListener("resize", function () {
      ...
      getSize: i, getContainerRectangles: function () {
        ...
        return {begin: o.get(c.rect, "begin") + c.translation, end: o.get(c.rect, "end") + c.translation};
      }, getBeginEndOfContainerVisibleRect: function () {
        return {begin: o.get(c.visibleRect, "begin") + c.translation, end: o.get(c.visibleRect, "end") + c.translation};
      ...
      }, getAxisValue: a, setTranslation: function (e, t) {
  ...
  var Q, Z, $, ee = function (e) {
    var u = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1500, r = e.reduce(function (e, t) {
      var n = function (e) {
  ...
  var te = {overflow: "hidden", display: "block"},
    ne = {height: "100%", display: "table-cell", "vertical-align": "top"}, oe = (m($ = {}, ".".concat(g), {
      position: "relative",
      "min-height": "30px",
      "min-width": "30px"
    }), m($, ".".concat(g, ".horizontal"), {display: "table"}), m($, ".".concat(g, ".horizontal > .").concat(h), {display: "inline-block"}), m($, ".".concat(g, ".horizontal > .").concat(f), ne), m($, ".".concat(g, ".vertical > .").concat(f), te), m($, ".".concat(f), {"box-sizing": "border-box"}), m($, ".".concat(f, ".horizontal"), ne), m($, ".".concat(f, ".vertical"), te), m($, ".".concat(f, ".animated"), {transition: "transform ease"}), m($, ".".concat(v), {"box-sizing": "border-box"}), m($, ".".concat(v, ".animated"), {transition: "all ease-in-out"}), m($, ".".concat(v, " *"), {"pointer-events": "none"}), m($, ".".concat(s, " *"), {
      "touch-action": "none",
      ...
      "-ms-user-select": "none",
      "user-select": "none"
    }), m($, ".".concat(w), {flex: "1"}), m($, ".".concat(g, ".horizontal > .").concat(x), {
      height: "100%",
      overflow: "hidden",
      display: "table-cell",
      "vertical-align": "top"
      ...
      "align-items": "stretch"
    }), m($, ".".concat(b), {"background-color": "rgba(150, 150, 150, 0.1)", border: "1px solid #ccc"}), $);
  ...
  var Ae, Ie, Be, Pe, Te, ze, Ne = (Pe = null, Te = 1, ze = 5, function (e, t, n) {
    ...
    }, {passive: !1}), window.document.addEventListener("drag", je, {passive: !1});
  });

  function Le(e) {
    var t = Je(e), n = t.clientX, o = t.clientY;
  ...
  function _e() {
    ...
    }, {passive: !1}), window.document.removeEventListener("drag", je, {passive: !1});
  }
  ...
  function Ve(e) {
    ...
    if (!ve && (void 0 === t.button || 0 === t.button) && (fe = N(t.target, "." + f))) {
      var n = N(fe, "." + g), o = pe.filter(function (e) {
        return e.element === n;
      ...
      a && Ne(t, o.getOptions().dragBeginDelay, function () {
        V(), et(t, X(e.target)), ce.forEach(function (e) {
          window.document.addEventListener(e, Xe, {passive: !1});
        }), ue.forEach(function (e) {
          window.document.addEventListener(e, Ue, {passive: !1});
        });
      });
    }
  }
  ...
  function Ue() {
    ce.forEach(function (e) {
      window.document.removeEventListener(e, Xe, {passive: !1});
    }), ue.forEach(function (e) {
      window.document.removeEventListener(e, Ue, {passive: !1});
    }), xe({reset: !0}), Ce && (function (e) {
  ...
  function Qe(e) {
    ...
    return function (e) {
      return !(null !== n || !ve || ye) && (n = requestAnimationFrame(function () {
        ve && !ye && (Ke(e, t), xe({draggableInfo: e})), n = null;
      }), !0);
    };
  }
  ...
  function et(e, t) {
    if (null !== fe) {
      ...
      n.setDraggables(), Ee = n.getOptions().lockAxis ? n.getOptions().lockAxis.toLowerCase() : null, me = function (t) {
        ...
        })[0], n = e.draggables.indexOf(t), o = e.getOptions().getGhostParent, r = t.getBoundingClientRect();
        return {
          container: e,
          element: t,
          size: {offsetHeight: r.bottom - r.top, offsetWidth: r.right - r.left},
          elementIndex: n,
        ...
        var r = t.x, i = t.y, a = e.getBoundingClientRect(), l = a.left, s = a.top, c = a.right, u = a.bottom,
          d = A(n.layout.getContainerRectangles().visibleRect, a), f = d.left + (d.right - d.left) / 2,
          g = d.top + (d.bottom - d.top) / 2, m = e.cloneNode(!0);
        return m.style.zIndex = "1000", m.style.boxSizing = "border-box", m.style.position = "fixed", m.style.top = "0px", m.style.left = "0px", m.style.transform = null, m.style.removeProperty("transform"), n.shouldUseTransformForGhost() ? m.style.transform = "translate3d(".concat(l, "px, ").concat(s, "px, 0)") : (m.style.top = "".concat(s, "px"), m.style.left = "".concat(l, "px")), m.style.width = c - l + "px", m.style.height = u - s + "px", m.style.overflow = "visible", m.style.transition = null, m.style.removeProperty("transition"), m.style.pointerEvents = "none", m.style.userSelect = "none", n.getOptions().dragClass ? setTimeout(function () {
          ...
          ghost: m,
          centerDelta: {x: f - r, y: g - i},
          positionDelta: {left: l - r, top: s - i},
          topLeft: {x: l, y: s}
        };
      }(fe, {x: e.clientX, y: e.clientY}, me.container, t), me.position = {
  ...
  function nt() {
    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
      ...
      n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], o = ge, r = o.ghost, i = o.topLeft, a = i.x,
      l = i.y, s = !me.container || me.container.shouldUseTransformForGhost(),
    ...
    register: function (e) {
      ...
      !function (e) {
        if (pe.splice(pe.indexOf(e), 1), ve && me) {
          ...
          var t = de.indexOf(e);
          -1 < t && (de.splice(t, 1), xe && xe({reset: !0, draggableInfo: void 0}), xe = Ze(e, de), we = Qe(de));
        }
      }(e);
    }, isDragging: function () {
      return ve;
  ...
  function st(e) {
    var t = e.element, n = e.draggables, o = e.layout, a = e.getOptions, l = function (e) {
        var t = e.element, n = e.draggables, o = e.layout;
        return function () {
          n.forEach(function (e) {
            it(e, !1), o.setTranslation(e, 0), o.setVisibility(e, !0);
          }), t[y] && (t[y].parentNode.removeChild(t[y]), t[y] = null);
        };
      }({element: t, draggables: n, layout: o, getOptions: a}),
      s = (It.dropHandler || Y)({element: t, draggables: n, layout: o, getOptions: a});
    return function (e, t) {
      var n = t.addedIndex, o = t.removedIndex, r = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
      if (l(), !e.cancelDrop && (e.targetElement || a().removeOnDropOut || r)) {
        var i = {removedIndex: o, addedIndex: null !== n ? null !== o && o < n ? n - 1 : n : null, payload: e.payload};
        s(i, a().onDrop);
      }
    };
  }
  ...
  function vt(e) {
    ...
    return function (e) {
      var t = e.dragResult, n = t.elementSize, o = t.shadowBeginEnd, r = t.addedIndex, i = t.dropPlaceholderContainer,
        a = p();
  ...
  function yt(e) {
    var o = function (e) {
      var i = e.draggables, a = lt({layout: e.layout});
      return function (e) {
      ...
      if (null === o) if (null !== n) {
        if (!m) {
          ...
          if (a < l + r) {
            ...
            return f.setSize(m.style, "".concat(s, "px")), u.appendChild(m), u[y] = m, {containerBoxChanged: !0};
          }
        }
      } else if (m) {
        f.setTranslation(m, 0);
        var c = m;
        return m = null, u.removeChild(c), {containerBoxChanged: !(u[y] = null)};
      }
    };
  }
  ...
  function Et(e) {
    ...
    return function (e) {
      var t = e.draggableInfo, n = e.dragResult, o = n.addedIndex, r = n.removedIndex, i = n.elementSize, a = n.pos,
        l = n.shadowBeginEnd;
  ...
  function St(e) {
    ...
    return function (e) {
      var t = e.dragResult, n = t.addedIndex, o = t.removedIndex, r = e.draggableInfo, i = r.payload, a = r.element;
      __targetElement = a;
  ...
  function At(d) {
    return function (e) {
      var n = Object.assign({}, C, e), t = null, o = null, r = function (e, t) {
        var n = at(e), o = t();
      ...
      }(d, u), i = Ot(r), a = st(r), l = function (t, n) {
        var o = [];
      ...
      return {
        element: d, draggables: r.draggables, isDragRelevant: function (e) {
          var r = e.element, i = e.getOptions;
          return function (e, t) {
            var n = i();
        ...
        }(r), layout: r.layout, dispose: function (e) {
          ...
          var n = e.element, o = r.draggables;
          ...
          a(o, Object.assign({}, t, {addedIndex: null}), !0), t = null;
        ...
        }, getOptions: u, setOptions: function (e) {
  ...
  }, Bt(Pt, It, "useTransformForGhost"), Bt(Pt, It, "maxScrollSpeed"), Bt(Pt, It, "wrapChild"), Bt(Pt, It, "dropHandler"), e.smoothDnD = It, e.constants = n, e.dropHandlers = k, e.default = Pt, Object.defineProperty(e, "__esModule", {value: !0});
});
/* eslint-enable */
