...
import {keyMenu, keyRefreshToken, keyToken, keyUser, passChat} from "variable";
...
const Global = ({ children }) => {
  ...
  const login = (data) => {
    ...
    localStorage.setItem('listVehicle',JSON.stringify( data.listVehicle));
    localStorage.setItem('listRequest',JSON.stringify( data.listRequest));
