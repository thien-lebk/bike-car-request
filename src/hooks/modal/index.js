...
const Hook = (
  {
    title, widthModal = 800, onOk, onCancel, GetById, isLoading, setIsLoading,
    firstChange = true, textSubmit, customFooter,className
  }
) => {
          ...
          <div className="flex justify-end">
            ...
            <button
              ...
              className={classNames("px-4 py-2.5 rounded-xl inline-flex items-center btn-save", {
                'bg-gray-100 hover:bg-gray-300 hover:text-white text-gray-400': !firstChange, 'text-white bg-blue-500 hover:bg-blue-400': firstChange,
              })}
              onClick={handleOk}
            >
