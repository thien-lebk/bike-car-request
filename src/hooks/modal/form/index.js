...
const Hook = (
  {
    ...
    firstRun, widthModal = 1200, columns, textSubmit, idElement,className,...propForm
  }
) => {
  ...
  const [handleShow, Modal] = HookModal({
    widthModal, isLoading, setIsLoading, firstChange, idElement: 'modal-form-' + idElement,className,textSubmit:textSubmit,
